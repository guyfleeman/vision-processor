...
type SSL_WrapperPacket struct {
	...
	Config        *SSL_VPConfig          `protobuf:"bytes,4,opt,name=config" json:"config,omitempty"`
...
func (x *SSL_WrapperPacket) GetConfig() *SSL_VPConfig {
	if x != nil {
		return x.Config
	}
	return nil
...
const file_vision_ssl_vision_wrapper_proto_rawDesc = "" +
	"\n" +
	"\x1fvision/ssl_vision_wrapper.proto\x1a!vision/ssl_vision_detection.proto\x1a vision/ssl_vision_geometry.proto\x1a\x1avision/ssl_vp_config.proto\"\xc1\x01\n" +
	...
	"\x06source\x18\x03 \x01(\x0e2\v.SSL_SourceR\x06source\x12%\n" +
	"\x06config\x18\x04 \x01(\v2\r.SSL_VPConfigR\x06config*\xa8\x01\n" +
	"\n" +
	"SSL_Source\x12\x16\n" +
	...
	"\x16SSL_SOURCE_ERFORCE_SIM\x10\x05BZB\x15SslVisionWrapperProtoP\x01Z?github.com/RoboCup-SSL/ssl-vision-processor/gui/internal/vision"
...
var file_vision_ssl_vision_wrapper_proto_goTypes = []any{
	...
	(*SSL_VPConfig)(nil),       // 4: SSL_VPConfig
}
var file_vision_ssl_vision_wrapper_proto_depIdxs = []int32{
	...
	4, // 3: SSL_WrapperPacket.config:type_name -> SSL_VPConfig
...
func file_vision_ssl_vision_wrapper_proto_init() {
	...
	file_vision_ssl_vp_config_proto_init()
	type x struct{}
