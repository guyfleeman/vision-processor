...
type SSL_DetectionFrame struct {
	...
	TOffsets []float32 `protobuf:"fixed32,9,rep,name=t_offsets,json=tOffsets" json:"t_offsets,omitempty"`
...
func (x *SSL_DetectionFrame) GetTOffsets() []float32 {
	if x != nil {
		return x.TOffsets
	}
	return nil
...
const file_vision_ssl_vision_detection_proto_rawDesc = "" +
	...
	"\x06height\x18\b \x01(\x02R\x06height\"\xe9\x02\n" +
	...
	"\tt_offsets\x18\t \x03(\x02R\btOffsets\x12\x1b\n" +
	...
	"robotsBlueB\\B\x17SslVisionDetectionProtoP\x01Z?github.com/RoboCup-SSL/ssl-vision-processor/gui/internal/vision"
