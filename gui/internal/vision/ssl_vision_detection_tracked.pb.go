...
// 	protoc        (unknown)
// source: vision/ssl_vision_detection_tracked.proto
...
func (Capability) Descriptor() protoreflect.EnumDescriptor {
	return file_vision_ssl_vision_detection_tracked_proto_enumTypes[0].Descriptor()
}

func (Capability) Type() protoreflect.EnumType {
	return &file_vision_ssl_vision_detection_tracked_proto_enumTypes[0]
}
...
func (Capability) EnumDescriptor() ([]byte, []int) {
	return file_vision_ssl_vision_detection_tracked_proto_rawDescGZIP(), []int{0}
}
...
type TrackedBall struct {
	...
	Pos *gamecontroller.Vector3 `protobuf:"bytes,1,req,name=pos" json:"pos,omitempty"`
	// The velocity [m/s] in the ssl-vision coordinate system
	Vel *gamecontroller.Vector3 `protobuf:"bytes,2,opt,name=vel" json:"vel,omitempty"`
...
func (x *TrackedBall) Reset() {
	*x = TrackedBall{}
	mi := &file_vision_ssl_vision_detection_tracked_proto_msgTypes[0]
...
func (x *TrackedBall) GetPos() *gamecontroller.Vector3 {
	if x != nil {
		return x.Pos
	}
	return nil
...
func (x *TrackedBall) GetVel() *gamecontroller.Vector3 {
	if x != nil {
		return x.Vel
	}
	return nil
...
type KickedBall struct {
	...
	Pos *gamecontroller.Vector2 `protobuf:"bytes,1,req,name=pos" json:"pos,omitempty"`
	// The initial velocity [m/s] with which the ball was kicked
	Vel *gamecontroller.Vector3 `protobuf:"bytes,2,req,name=vel" json:"vel,omitempty"`
	...
	StopPos *gamecontroller.Vector2 `protobuf:"bytes,5,opt,name=stop_pos,json=stopPos" json:"stop_pos,omitempty"`
	// The robot that kicked the ball
	RobotId       *gamecontroller.RobotId `protobuf:"bytes,6,opt,name=robot_id,json=robotId" json:"robot_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *KickedBall) Reset() {
	*x = KickedBall{}
	mi := &file_vision_ssl_vision_detection_tracked_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KickedBall) Descriptor() ([]byte, []int) {
	return file_vision_ssl_vision_detection_tracked_proto_rawDescGZIP(), []int{1}
}

func (x *KickedBall) GetPos() *gamecontroller.Vector2 {
	if x != nil {
		return x.Pos
	}
	return nil
...
func (x *KickedBall) GetVel() *gamecontroller.Vector3 {
	if x != nil {
		return x.Vel
	}
	return nil
...
func (x *KickedBall) GetStopPos() *gamecontroller.Vector2 {
	if x != nil {
		return x.StopPos
	}
	return nil
...
func (x *KickedBall) GetRobotId() *gamecontroller.RobotId {
	if x != nil {
		return x.RobotId
	}
	return nil
...
type TrackedRobot struct {
	state   protoimpl.MessageState  `protogen:"open.v1"`
	RobotId *gamecontroller.RobotId `protobuf:"bytes,1,req,name=robot_id,json=robotId" json:"robot_id,omitempty"`
	// The position [m] in the ssl-vision coordinate system
	Pos *gamecontroller.Vector2 `protobuf:"bytes,2,req,name=pos" json:"pos,omitempty"`
	...
	// The velocity [m/s] in the ssl-vision coordinate system
	Vel *gamecontroller.Vector2 `protobuf:"bytes,4,opt,name=vel" json:"vel,omitempty"`
...
func (x *TrackedRobot) Reset() {
	*x = TrackedRobot{}
	mi := &file_vision_ssl_vision_detection_tracked_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TrackedRobot) Descriptor() ([]byte, []int) {
	return file_vision_ssl_vision_detection_tracked_proto_rawDescGZIP(), []int{2}
}

func (x *TrackedRobot) GetRobotId() *gamecontroller.RobotId {
	if x != nil {
		return x.RobotId
	}
	return nil
...
func (x *TrackedRobot) GetPos() *gamecontroller.Vector2 {
	if x != nil {
		return x.Pos
	}
	return nil
...
func (x *TrackedRobot) GetVel() *gamecontroller.Vector2 {
	if x != nil {
		return x.Vel
	}
	return nil
...
func (x *TrackedFrame) Reset() {
	*x = TrackedFrame{}
	mi := &file_vision_ssl_vision_detection_tracked_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TrackedFrame) Descriptor() ([]byte, []int) {
	return file_vision_ssl_vision_detection_tracked_proto_rawDescGZIP(), []int{3}
}
...
var File_vision_ssl_vision_detection_tracked_proto protoreflect.FileDescriptor

const file_vision_ssl_vision_detection_tracked_proto_rawDesc = "" +
	"\n" +
	")vision/ssl_vision_detection_tracked.proto\x1a\"gamecontroller/ssl_gc_common.proto\x1a$gamecontroller/ssl_gc_geometry.proto\"e\n" +
	...
	"\x1eCAPABILITY_DETECT_KICKED_BALLS\x10\x03BcB\x1eSslVisionDetectionTrackedProtoP\x01Z?github.com/RoboCup-SSL/ssl-vision-processor/gui/internal/vision"

var (
	file_vision_ssl_vision_detection_tracked_proto_rawDescOnce sync.Once
	file_vision_ssl_vision_detection_tracked_proto_rawDescData []byte
)

func file_vision_ssl_vision_detection_tracked_proto_rawDescGZIP() []byte {
	file_vision_ssl_vision_detection_tracked_proto_rawDescOnce.Do(func() {
		file_vision_ssl_vision_detection_tracked_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_vision_ssl_vision_detection_tracked_proto_rawDesc), len(file_vision_ssl_vision_detection_tracked_proto_rawDesc)))
	})
	return file_vision_ssl_vision_detection_tracked_proto_rawDescData
}

var file_vision_ssl_vision_detection_tracked_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_vision_ssl_vision_detection_tracked_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_vision_ssl_vision_detection_tracked_proto_goTypes = []any{
	...
	(*gamecontroller.Vector3)(nil), // 5: Vector3
	(*gamecontroller.Vector2)(nil), // 6: Vector2
	(*gamecontroller.RobotId)(nil), // 7: RobotId
}
var file_vision_ssl_vision_detection_tracked_proto_depIdxs = []int32{
...
func init() { file_vision_ssl_vision_detection_tracked_proto_init() }
func file_vision_ssl_vision_detection_tracked_proto_init() {
	if File_vision_ssl_vision_detection_tracked_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_vision_ssl_vision_detection_tracked_proto_rawDesc), len(file_vision_ssl_vision_detection_tracked_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_vision_ssl_vision_detection_tracked_proto_goTypes,
		DependencyIndexes: file_vision_ssl_vision_detection_tracked_proto_depIdxs,
		EnumInfos:         file_vision_ssl_vision_detection_tracked_proto_enumTypes,
		MessageInfos:      file_vision_ssl_vision_detection_tracked_proto_msgTypes,
	}.Build()
	File_vision_ssl_vision_detection_tracked_proto = out.File
	file_vision_ssl_vision_detection_tracked_proto_goTypes = nil
	file_vision_ssl_vision_detection_tracked_proto_depIdxs = nil
}
