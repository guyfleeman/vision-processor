...
// @generated from file vision/ssl_vision_detection_tracked.proto (syntax proto2)
/* eslint-disable */

import type { GenEnum, GenFile, GenMessage } from "@bufbuild/protobuf/codegenv1";
import { enumDesc, fileDesc, messageDesc } from "@bufbuild/protobuf/codegenv1";
import type { RobotId, RobotIdJson } from "../gamecontroller/ssl_gc_common_pb";
import { file_gamecontroller_ssl_gc_common } from "../gamecontroller/ssl_gc_common_pb";
import type { Vector2, Vector2Json, Vector3, Vector3Json } from "../gamecontroller/ssl_gc_geometry_pb";
import { file_gamecontroller_ssl_gc_geometry } from "../gamecontroller/ssl_gc_geometry_pb";
import type { Message } from "@bufbuild/protobuf";

/**
 * Describes the file vision/ssl_vision_detection_tracked.proto.
 */
export const file_vision_ssl_vision_detection_tracked: GenFile = /*@__PURE__*/
  fileDesc("", [file_gamecontroller_ssl_gc_common, file_gamecontroller_ssl_gc_geometry]);
...
export const TrackedBallSchema: GenMessage<TrackedBall, TrackedBallJson> = /*@__PURE__*/
  messageDesc(file_vision_ssl_vision_detection_tracked, 0);
...
export const KickedBallSchema: GenMessage<KickedBall, KickedBallJson> = /*@__PURE__*/
  messageDesc(file_vision_ssl_vision_detection_tracked, 1);
...
export const TrackedRobotSchema: GenMessage<TrackedRobot, TrackedRobotJson> = /*@__PURE__*/
  messageDesc(file_vision_ssl_vision_detection_tracked, 2);
...
export const TrackedFrameSchema: GenMessage<TrackedFrame, TrackedFrameJson> = /*@__PURE__*/
  messageDesc(file_vision_ssl_vision_detection_tracked, 3);
...
export const CapabilitySchema: GenEnum<Capability, CapabilityJson> = /*@__PURE__*/
  enumDesc(file_vision_ssl_vision_detection_tracked, 0);
