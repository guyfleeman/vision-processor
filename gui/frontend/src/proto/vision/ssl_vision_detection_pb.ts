...
export const file_vision_ssl_vision_detection: GenFile = /*@__PURE__*/
  fileDesc("");
...
export type SSL_DetectionFrame = Message<"SSL_DetectionFrame"> & {
   ...
   * containing the time offset of received packets for each cam relative to the local clock.
   *
   * @generated from field: repeated float t_offsets = 9;
   */
  tOffsets: number[];
...
export type SSL_DetectionFrameJson = {
   ...
   * @generated from field: repeated float t_offsets = 9;
   */
  tOffsets?: (number | "NaN" | "Infinity" | "-Infinity")[];
